...
public class Edificaciones {
    ...
    public void construirEdificacion(String opcion){
        ...
        //Si el grupoSolar está hipotecado, no se podrá construir:
        if (getGrupoSolar().getEsHipotecada()){
            System.out.println("No puedes construir edificios en esta casilla porque está hipotecada.");
        }
    ...
    //Método ampliado para imprimir cuantas cosas se pueden construir todavía:
    public int esMaxEdificacionesAmpliado(String edificio){
        ...
        switch (edificio){
            ...
            case "casa":
                ...
                //Si pasa los dos checks:
                int casasRestantes;
                //CASO DONDE NO HAYA MAX HOTELES:
                if (getNumHoteles() < getMaxEdificaciones()){
                    casasRestantes = 4 - getNumCasas();
                    System.out.println("Puedes edificar " + casasRestantes + " casas todavía y cambiarlas por un hotel.");
                }

                //CASO DONDE SI HAYA DOS HOTELES
                else if (getNumHoteles() == getMaxEdificaciones()){
                    casasRestantes = getMaxEdificaciones() - getNumCasas();
                    System.out.println("Puedes edificar " + casasRestantes + " casas como máximo.");
                }
            ...
            case "hotel":
                ...
                //Si pasa el check imprimimos que se puede edificar:
                int hotelesRestantes;
                hotelesRestantes = getMaxEdificaciones() - getNumHoteles();
                System.out.println("Puedes edificar " + hotelesRestantes + " hoteles todavía");
                return 0;
            ...
            case "piscina":
                ...
                //Si pasa el check imprimimos que se puede edificar:
                int piscinasRestantes;
                piscinasRestantes = getMaxEdificaciones() - getNumPiscinas();
                System.out.println("Puedes edificar " + piscinasRestantes + " piscinas todavía");
                return 0;
            ...
            case "pistaDeportes":
                ...
                //Si pasa el check imprimimos que se puede edificar:
                int pistaDeportesRestantes;
                pistaDeportesRestantes = getMaxEdificaciones() - getNumPistasDeporte();
                System.out.println("Puedes edificar " + pistaDeportesRestantes + " pistas de deportes todavía");
                return 0;
