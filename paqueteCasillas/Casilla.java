...
public class Casilla {
    ...
    public static void realizarAccionesCasilla(EstadoPartida estadoPartida,Casilla casilla, Jugador jugador) {
        ...
        if(casilla.getGrupoCasilla().equals("Transporte")) {
            ...
            if ((!propietario.getNombre().equals("Banca")) && (!propietario.equals(jugador))) {
                //Si esta hipotecada, no se cobrará el alquiler.
                if (casilla.getGrupoTransporte().getEsHipotecada()){
                    System.out.println("Esta casilla de transporte pertenece a " + propietario.getNombre() + ", pero al estar" +
                            " hipotecada no se te ha cobrado el alquiler.");
                }
                else {
                    ...
                    casilla.getGrupoTransporte().cobrarAlquiler(estadoPartida,jugador);
                    //Printear la cantidad que se ha pagado y a quien se ha pagado
        ...
        if(casilla.getGrupoCasilla().equals("Servicios")) {
            ...
            if ((!propietario.getNombre().equals("Banca")) && (!propietario.equals(jugador))) {
                //Si esta hipotecada, no se cobrará el alquiler.
                if (casilla.getGrupoServicios().getEsHipotecada()){
                    System.out.println("Esta casilla de servicios pertenece a " + propietario.getNombre() + ", pero al estar" +
                            " hipotecada no se te ha cobrado el alquiler.");
                }
                else {
                    casilla.getGrupoServicios().cobrarAlquiler(estadoPartida,jugador);
                    //Printear la cantidad que se ha pagado y a quien se ha pagado
